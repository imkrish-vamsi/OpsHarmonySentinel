# ! pip3 install langchain scipy datasets transformers trl peft accelerate bitsandbytes auto-gptq optimum
import sys
sys.path.append('/home/paperspace/documents/OpsHarmonySentinel')
...
from utils.model_train_util import TrainConfig
...
class Trainer:
    ...
    def __init__(self):
        ...
        self.base_model = AutoModelForCausalLM.from_pretrained(self.config.MODEL_ID, model_file=self.config.MODEL_FILE, model_type=self.config.MODEL_TYPE)
        # self.base_model = AutoModelForCausalLM.from_pretrained(r"/home/paperspace/documents/OpsHarmonySentinel/model/files/zephyr-7b-beta.Q8_0.gguf", model_type=self.config.MODEL_TYPE)
        # self.tokenizer = self.base_model.tokenize
        self.tokenizer = AutoTokenizer.from_pretrained(self.base_model)
        # self.base_model = CTransformers(model=r"/home/tranquility/documents/OpsHarmonySentinel/model/files/zephyr-7b-beta.Q8_0.gguf", model_type=self.config.MODEL_TYPE)
    ...
    def prepare_model(self):
        ...
        #                                             )
        model = AutoModelForCausalLM.from_pretrained(r"/home/paperspace/documents/OpsHarmonySentinel/model/files/zephyr-7b-beta.Q8_0.gguf",
                                                     quantization_config=bnb_config,
                                                     device_map=self.config.DEVICE_MAP)
